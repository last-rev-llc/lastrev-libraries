...
export default {
  hit: {
    ...
    path: '/news/ias-acquires-context/#About Integral Ad Science',
    categories: ['Advertiser + Agency Solutions', 'Getting Started'],
    _tags: ['Advertiser + Agency Solutions', 'Getting Started'],
    categoryLinks: [
      { name: 'Advertiser + Agency Solutions', href: 'https://ias.com/Advertiser_Agency_Solutions' },
      { name: 'Getting Started', href: 'https://ias.com/Getting_Started' }
    ],
    summary:
