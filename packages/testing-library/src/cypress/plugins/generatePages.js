...
const generatePages = async ({ nextPagesPath, fixturePagesPath, integrationPath }) => {
  // Generate and store pages fixture
  const GENERATED_PAGES_FILENAME = path.join(fixturePagesPath, 'generated_pages.json');
  let PAGES;
