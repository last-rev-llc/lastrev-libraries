...
describe('sitemap-generator', () => {
  test('generates valid index and sitemap files', async () => {
    ...
    const page1 = fs.readFileSync(path.resolve(__dirname, '../../out/page1'), { encoding: 'utf8' });
    const page2 = fs.readFileSync(path.resolve(__dirname, '../../out/page2'), { encoding: 'utf8' });
    const page3 = fs.readFileSync(path.resolve(__dirname, '../../out/page3'), { encoding: 'utf8' });
