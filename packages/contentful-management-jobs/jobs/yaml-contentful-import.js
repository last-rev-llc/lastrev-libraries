...
const CONTENTFUL_CONTENT_TYPE_TO_IMPORT = 'pageUseCasesMain'; // The main content type that is being imported
const BASE_FOLDER_PATH = '/home/max/dev/workato-website/content/use_cases_main'; // The local folder to import yaml files from
const CUSTOM_PARSER_LOOKUP = require('../migrations/pageUseCasesMain');
