...
const defaultProps: ComponentsProps['CategoryBlog'] = {};

const styleOverrides: ComponentsOverrides<Theme>['CategoryBlog'] = {
  root: ({ theme }) => ({
...
const createVariants = (_theme: Theme): ComponentsVariants['CategoryBlog'] => [];

export const categoryblogTheme = (theme: Theme): ThemeOptions => ({
  components: {
    CategoryBlog: {
      defaultProps,
      styleOverrides,
...
export default categoryblogTheme;
