...
type ApplyGrid = (args: { theme: Theme; ownerState: any }) => CSSProperties;
...
export const applyGrid: ApplyGrid = ({ ownerState, theme }: { ownerState?: any; theme: Theme }) => {
  const overrideNested: string = ownerState?.overrideNested;
