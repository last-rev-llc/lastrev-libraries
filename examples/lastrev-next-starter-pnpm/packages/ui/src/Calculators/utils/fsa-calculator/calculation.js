...
export const getCalculations = (form, tax, recommendations = {}) => {
  ...
  if (recommendations.fsa) {
    ...
    payload.push({
      ...
      maxText: `Based on your annual expenses, you should plan to contribute $${numberWithCommas(
        Math.round(recommended)
      )} towards your LPFSA this year. You can contribute up to $${numberWithCommas(CURRENT_YEAR_ANNUAL_FSA_LIMIT)}.`,
      estimate,
  ...
  if (recommendations.dcfsa) {
    ...
    payload.push({
      ...
      maxText: `Based on your annual expenses, you should plan to contribute $${numberWithCommas(
        Math.round(recommended)
      )} towards your Dependent Care FSA this year. You can contribute up to $${numberWithCommas(Math.round(limit))}.`,
      estimate,
