...
const SmallResult = ({ results, handleNavigation }) => {
  ...
  return (
    <Container>
      ...
      <ExplanationsContainer>
        <Explanations max={{ text: maxText, value: maxAllowed }} estimated={{ text: estimateText, value: estimate }} />
      </ExplanationsContainer>
      <Section>
  ...
  <Container>
    <SectionContainer>
      ...
      <Section paddingBottom="25px">
        <CustomButton handleClick={handleNavigation} background={'transparent'} kind={'navigate'} value={'Back'} />
      </Section>
    </SectionContainer>
  </Container>
);
