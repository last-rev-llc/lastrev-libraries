...
export function middleware(request: NextRequest) {
  const cspHeader = `
    default-src 'self'  localhost:8888 *.sentry.io  *.facebook.com vitals.vercel-insights.com *.hubapi.com *.hsforms.com *.hs-scripts.com *.hsforms.net *.hscollectedforms.net;
